...
- **Form 1098-Q / QLAC (added 2026-09-11, sc_00320)** — an issuer-filed information return, not a return attachment. Instructions for Form 1098-Q: "Any person who **issues** a contract intended to be a QLAC … must file Form 1098-Q", and the participant's copy exists "to report the **status of the contract**". The $210,000 (2025, Notice 2024-80) lifetime premium cap is enforced by the issuer at purchase, and the RMD exclusion happens inside the custodian's RMD calculation — neither has a line on Form 1040 or any schedule. The QLAC does reach a return indirectly, through the smaller §4974 shortfall a filer reports on Form 5329 Part IX, and that path already works.
