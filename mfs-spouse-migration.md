...
### Deductions
27. ☐ **Additional deductions** — `additional-deductions-taxpayer` ↔ `-spouse` (generic; Schedule 1-A). Bucket A — ★ CHECK both prefixed-form gap variants ([[feedback_mfs_spouse_prefixed_form_scoper_unprefix]]). **← CURRENT**
