...
24. ☐ **US possession exclusion** — `possession-residence-exclusion-taxpayer` ↔ `-spouse` (generic; Form 4563). Bucket A — ★ CHECK for the prefixed-form scoper gap ([[feedback_mfs_spouse_prefixed_form_scoper_unprefix]]). **← CURRENT**
