...
- **Other affected children's preferential income + 28%/§1250 Schedule D Tax Worksheet.** In a multi-child kiddie-tax family, the other children's preferential income (Form 8615 line 7) is treated as fully ordinary; and the 28%-rate/§1250 Schedule D Tax Worksheet path (collectibles / unrecaptured §1250 — rare for a child) remains on the QDCG 0/15/20 approximation. The manual `childFinalTaxLine18` override covers both.
