...
- **Increment 3 (next) — `OutForm8853` output persistence** (per-person, mirrors `OutForm8889`) + `TaxReturnComputation` record. **Increment 4 — e2e.** **Constraint:** no `form-tax-return-8853` preview or 1099-SA/1099-LTC statement changes.
