...
Updated: 2026-06-23T22:00:00-04:00

**★ MFS Spouse-Forms Migration — IN PROGRESS (queue #12–#45 done; #46–#50 remain), updated 2026-06-24.** (An earlier note prematurely said "#12–#44 COMPLETE" — corrected: the queue runs to #50 — #46 Form 4868, #47 estimated-tax, #48 Form 8862, #49 other-payments, #50 CTC settings remain.) Every migrated Spouse-tab form produces a correct standalone Married-Filing-Separately return. No blocking items remain from the work so far. The only deferred items it produced are minor per-form enhancements, tracked in their respective form sections below (all are filing-convenience / rare-edge gaps, NOT credit-value bugs): Form 8936 #33 (spouse MAGI add-back + prior-year-MAGI on the spouse form); Form 8834 #36 (spouse confirm-available field → cosmetic advisory note); Form 8859 #38 (spouse Schedule 8812 Worksheet B line-2 override); Form 8962 #39 (standalone spouse-leg APTC repayment via her own 1095-A / shared-policy allocation — needs a full mirror). The Form 1116 #42 simplified-exception deferral was RESOLVED same-day (full mirror). See `history.md` 2026-06-23 milestone + `rules.md` (MFS Spouse-Forms Migration — Canonical Rules) + `C:\us-tax\mfs-spouse-migration.md`.
