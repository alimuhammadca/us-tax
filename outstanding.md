...
- **Increment 2c (next) — Angular MSA/LTC form** (`msa-ltc-taxpayer`/`-spouse`) + sidebar. **Increment 3 — `OutForm8853` output persistence. Increment 4 — e2e.** **Constraint:** no `form-tax-return-8853` preview or 1099-SA/1099-LTC statement changes.
