...
- **Increment 3 (next) — output persistence + reload** (`OutForm8889` + mapper + migration + `TaxReturnComputation` record for taxpayer/spouse) so the computed worksheet survives a GET reload. **Increment 4 — e2e.**
