...
Out of scope (still open): Notice 2014-7 line 8s coupled to the EIC election. Detail: `history.md` 2026-06-30 / 07-06; memory `project_compute_validation_audit_2026q2`.
